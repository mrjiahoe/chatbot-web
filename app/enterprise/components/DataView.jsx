...
import { Database, Server, Loader2, Eye, Columns3 } from 'lucide-react';
            ...
            <div className="max-w-3xl mx-auto w-full px-6 md:px-8">
                ...
                <div className="space-y-3">
                    ...
                    {isLoading ? (
                        ...
                        tables.map((table) => (
                            <div key={table.name} className="flex items-center justify-between p-4 rounded-2xl bg-zinc-50 dark:bg-white/5 border border-transparent hover:border-zinc-200 dark:hover:border-white/10 transition-all group">
