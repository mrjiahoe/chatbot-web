...
If the schema metadata marks a table as "summary", treat it as a lower-priority option for filtered people/entity questions. Prefer entity, relationship, and lookup tables first.
Use summary tables when the user explicitly asks for precomputed totals/metrics, or when no suitable relational path exists in the approved schema.
For questions like "teachers with qualification Bachelor" or "female students in year 2", prefer row-level entity paths over generic metric tables.
