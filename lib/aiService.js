...
If the question asks for trends, comparisons, distributions, or analysis that is better handled in Python, return an "analysis" object.

Allowed query operations: select, count, average, sum
Allowed analysis types: trend, comparison, distribution
...
{
  "type": "analysis",
  "analysis": "<trend | comparison | distribution>",
  "table": "<table_name>",
  "column": "<column>",
  "group_by": "<column>"
}
