...
export const ROLE_DEFINITIONS = Object.freeze([
    ...
    },
    {
        value: 'owner',
        label: 'Owner',
        description: 'Workspace owner with elevated access to manage team roles.',
        permissions: [
            PERMISSIONS.ACCESS_CHAT,
            PERMISSIONS.VIEW_CHAT_HISTORY,
            PERMISSIONS.ACCESS_DATA_SOURCES,
    ...
    },
    {
        value: 'admin',
        label: 'Admin',
        description: 'Administrative user with access to chat, history, data sources, and a read-only role dashboard.',
        permissions: [
            PERMISSIONS.ACCESS_CHAT,
            PERMISSIONS.VIEW_CHAT_HISTORY,
            PERMISSIONS.ACCESS_DATA_SOURCES,
...
export function canAccessRoleDashboard(role) {
    return hasPermission(role, PERMISSIONS.ACCESS_ROLE_DASHBOARD);
}
...
export function canManageUserRoles(role) {
    return hasPermission(role, PERMISSIONS.MANAGE_USER_ROLES);
}
